...
class __TwigTemplate_dbd0301354148b8edc7a6d65c1402b7c7f5bd73058834af4fdba5ca60a95fed8 extends \Twig\Template
{
    private $source;
    private $macros = [];
...
{% block captcha_widget %}
    {% spaceless %}
        ...
        {{ form_widget(form, { 'id': user_input_id, 'value': '' }) }}
    {% endspaceless %}
{% endblock %}", "@Captcha/captcha.html.twig", "/var/www/jihene/web-sprint/vendor/captcha-com/symfony-captcha-bundle/Resources/views/captcha.html.twig");
    }
}
