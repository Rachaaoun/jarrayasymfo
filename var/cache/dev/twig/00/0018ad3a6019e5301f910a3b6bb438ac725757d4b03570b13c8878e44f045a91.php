...
/* stay/show.html.twig */
class __TwigTemplate_62f86a7d2115daa1d749cce66c032daa079b3a6776395a7ed4552e1bf42cc398 extends Template
{
    private $source;
    private $macros = [];
...
<br></br>
  ...
  class=\"maskImg\"</a>
    ...
    <a href=\"";
        // line 49
        echo twig_escape_filter($this->env, $this->extensions['Symfony\Bridge\Twig\Extension\RoutingExtension']->getPath("app_booking_new", ["id" => twig_get_attribute($this->env, $this->source, (isset($context["stay"]) || array_key_exists("stay", $context) ? $context["stay"] : (function () { throw new RuntimeError('Variable "stay" does not exist.', 49, $this->source); })()), "id", [], "any", false, false, false, 49)]), "html", null, true);
        echo "\" class=\"btn btn-info\" style=\"margin:5px;width:400px\">Book now
     <img src=\"/front/images/book.png\" alt=\"Image\"
  class=\"maskImg\"
    </a>
...
";
    ...
    {
        return array (  162 => 55,  154 => 49,  145 => 43,  136 => 37,  129 => 33,  122 => 29,  115 => 25,  108 => 21,  101 => 17,  88 => 6,  78 => 5,  59 => 3,  36 => 1,);
    }
...
<br></br>
  ...
  class=\"maskImg\"</a>
    ...
    <a href=\"{{ path('app_booking_new', {'id': stay.id}) }}\" class=\"btn btn-info\" style=\"margin:5px;width:400px\">Book now
     <img src=\"/front/images/book.png\" alt=\"Image\"
  class=\"maskImg\"
    </a>
