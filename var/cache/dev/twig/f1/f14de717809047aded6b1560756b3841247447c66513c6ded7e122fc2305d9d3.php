...
class __TwigTemplate_10943555c8f3ebcb05f0f3870dd1fb64e1b3e1176bdf5a57a3cc1bc53d94e8be extends Template
{
    private $source;
    private $macros = [];
    ...
    <div class=\"row\">
        <div class=\"col\">
            ";
        // line 10
        echo $this->env->getRuntime('Symfony\Component\Form\FormRenderer')->searchAndRenderBlock(twig_get_attribute($this->env, $this->source, (isset($context["form"]) || array_key_exists("form", $context) ? $context["form"] : (function () { throw new RuntimeError('Variable "form" does not exist.', 10, $this->source); })()), "i", [], "any", false, false, false, 10), 'row');
        echo "
        </div>
        <div class=\"col\" id=\"some-custom-id\">
            ";
        // line 13
        echo $this->env->getRuntime('Symfony\Component\Form\FormRenderer')->searchAndRenderBlock(twig_get_attribute($this->env, $this->source, (isset($context["form"]) || array_key_exists("form", $context) ? $context["form"] : (function () { throw new RuntimeError('Variable "form" does not exist.', 13, $this->source); })()), "j", [], "any", false, false, false, 13), 'row');
        echo "
        </div>

        <div class=\"col\">
            <button type=\"submit\" class=\"btn btn-primary w=100\">Look for a stay
    ...
    {
        return array (  99 => 24,  85 => 13,  79 => 10,  71 => 5,  66 => 3,  63 => 2,  44 => 1,);
    }
...
</br></br>{{ form_end(form) }}{% endblock %}
", "stay/_filtre.html.twig", "/var/www/jihene/web-sprint/templates/stay/_filtre.html.twig");
    }
}
